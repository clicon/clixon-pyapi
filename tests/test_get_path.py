...
def test7():
    ...
    e = get_path(
        root, "/devices-foo/device[device-name='juniper1']/config/configuration/system/login/user[name='admin']/uid")
    ...
    e = get_path(
        root, "/devices_foo/device[device_name='juniper1']/config/configuration/system/login/user[name='admin']/uid")
